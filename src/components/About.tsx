...
const stats = [
  { value: 7, suffix: "+", label: "Years Experience", icon: Code2, color: "primary" },
  { value: 25, suffix: "+", label: "Projects Shipped", icon: Rocket, color: "secondary" },
  { value: 8, suffix: "", label: "Companies", icon: MapPin, color: "accent" },
  { value: 150, suffix: "+", label: "Bugs Found", icon: Shield, color: "warning" },
];

const certifications = [
  { name: "OSCP", issuer: "Offensive Security", icon: Shield },
  { name: "AWS Pro", issuer: "Amazon Web Services", icon: Rocket },
  { name: "CISSP", issuer: "(ISC)²", icon: Terminal },
  { name: "CKA", issuer: "CNCF", icon: Code2 },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants} className="relative">
              ...
              <div className="pl-8">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  ...
                  <p>
                    With <span className="text-primary font-semibold">7+ years of professional experience</span>, 
                    I architect scalable systems and deploy bulletproof CI/CD pipelines by day. By night, 
                    I&apos;m an offensive security specialist, hunting vulnerabilities and building 
            ...
            <motion.div variants={itemVariants} className="pt-4">
              <h4 className="text-xs font-mono text-muted uppercase tracking-widest mb-4">Certifications</h4>
              <div className="flex flex-wrap gap-3">
                {certifications.map((cert) => (
                  <div key={cert.name} className="flex items-center gap-2 px-3 py-1.5 rounded-lg glass border border-white/5 hover:border-primary/30 transition-all">
                    <cert.icon className="w-3.5 h-3.5 text-primary" />
