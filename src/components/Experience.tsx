...
const experiences = [
  {
    ...
    color: "primary",
    description: "Leading technical strategy and architecting high-performance digital ecosystems. Overseeing full-stack development and security implementation for all client projects.",
    achievements: [
      "Architected 10+ enterprise-grade platforms",
      "Directed cross-functional dev teams",
      "Reduced infrastructure costs by 35%",
      "Secured $100k+ in client contracts"
    ],
    tech: ["Next.js", "TypeScript", "AWS Pro", "Docker"],
    icon: Sparkles
  },
  {
    id: 2,
    ...
    location: "Nairobi, Kenya",
    color: "secondary",
    description: "Advanced security consulting and custom automation development. specialized in penetration testing and secure infrastructure design.",
    achievements: [
      "Developed Shadow AI security engine",
      "Conducted 20+ vulnerability audits",
      "Published security research tools",
      "Top 1% on security platforms"
    ],
    tech: ["Python", "Rust", "Kali", "PostgreSQL"],
    icon: Shield
  },
  {
    id: 3,
    ...
    location: "Nairobi, Kenya",
    color: "accent",
    description: "Built and maintained complex inventory and logistics management systems. Optimized database performance and frontend responsiveness.",
    achievements: [
      "Optimized DB queries by 80%",
      "Implemented real-time tracking",
      "Built cross-platform mobile app",
      "Mentored 2 junior devs"
    ],
    tech: ["React", "Node.js", "Redis", "GraphQL"],
    icon: Cpu
  },
  {
    id: 4,
    company: "Telkom Kenya",
    role: "Security Analyst (Intern to Junior)",
    type: "Full-time",
    period: "May 2017 - Dec 2018",
    location: "Nairobi, Kenya",
    color: "warning",
    description: "Started as a high-performing intern and transitioned into a junior analyst role. Monitored network traffic and assisted in threat mitigation.",
    achievements: [
      "Detected 50+ critical threats",
      "Automated log analysis",
      "Created security training docs",
      "Honored as Intern of the Year"
    ],
    tech: ["SIEM", "Python", "Networking", "Wireshark"],
    icon: Building2
  }
];
...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} aria-labelledby="experience-heading" className="relative py-32 overflow-hidden">
      {/* Background */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 id="experience-heading" className="font-heading text-5xl md:text-6xl font-bold mb-4">
