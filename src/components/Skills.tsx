...
const skillCategories = [
  {
    ...
    skills: [
      { name: "Next.js 14", level: 98, years: 5 },
  ...
  },
  {
    ...
    skills: [
      { name: "Docker & K8s", level: 92, years: 4 },
      { name: "AWS Pro", level: 90, years: 4 },
  ...
  },
  {
    ...
    skills: [
      { name: "Penetration Testing", level: 94, years: 5 },
      { name: "Vulnerability Analysis", level: 92, years: 5 },
  ...
  },
  {
    ...
    skills: [
      { name: "LLM Engineering", level: 90, years: 2 },
