...
/**
 * ACTION REQUIRED: Update the projects array with your real data.
 * - Replace names, taglines, and descriptions.
 * - Update 'tech' stack arrays.
 * - IMPORTANT: Replace '#' in 'link' and 'github' with your actual URLs.
 */
const projects = [
  {
    id: 1,
    ...
    icon: Sparkles,
    status: "Live",
    link: "#", // Replace with your live demo URL
