...
export default function Contact() {
  ...
  React.useEffect(() => {
    const duration = getComputedStyle(document.documentElement).getPropertyValue('--animation-duration-normal');
    const easing = getComputedStyle(document.documentElement).getPropertyValue('--animation-easing');
    setAnimationConfig({
  ...
  const [formState, setFormState] = useState({
   ...
   const itemVariants = {
    ...
    visible: { 
      opacity: 1, 
      y: 0,
      transition: { duration: animationConfig.duration, easing: animationConfig.easing }
    }
  };
  ...
  const inputFields = [
   ...
   `}</style>
       ...
       <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="grid gap-12 sm:grid-cols-1 lg:grid-cols-5">
 ...
 <div className="relative p-6 sm:p-8 rounded-2xl glass border border-white/10">
                 {/* Form header */}
